...
| [lazycrontab](https://github.com/daviddwlee84/lazycrontab) | Inspect cron across hosts, build readable schedules, and review edits; early source-only version.       | [Not reviewed](docs/lazycrontab/README.md#agentic-development) | —                                                      |
...
| [lazypkg](https://github.com/daviddwlee84/lazypkg)         | Browse packages across managers, inspect PATH sources and review scoped or batch changes; early source release. | [Documented use](docs/lazypkg/README.md)     | Source / transcript published: 2026-09-24                         |
...
This list's maintainer also maintains **dev-cli, exp-cli, lazyansible, lazychezmoi, lazyclash, lazycrontab, lazyfind, lazymlflow, lazypkg, and lazypueue**. lazyansible is a permanent personal fork of kocierik/lazyansible. They follow the same inclusion and evidence rules as other entries. New public source repositories are not automatically stable releases. lazycrontab, lazyfind and lazypkg have source-only tags; no binary distribution or GitHub Release accompanied their publication. Their notes describe the inspected version and known limitations.
